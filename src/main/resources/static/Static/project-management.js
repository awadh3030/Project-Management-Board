...
function loadCards() {
    fetch("http://localhost:8080/api/boards/1/cards")
        ...
        .then(cards => {
            cards.forEach(card => {
                let sectionNumber = card.section;
                let columnDiv;
                if (sectionNumber === 1) {
                    columnDiv = document.getElementById("todoContainer");
                } else if (sectionNumber === 2) {
                    columnDiv = document.getElementById("inProgressContainer");
                } else {
                    columnDiv = document.getElementById("doneContainer");
                }
